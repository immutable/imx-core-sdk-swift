...
public struct TransferRequest: Codable, Hashable {
    ...
    public init(amount: String, assetId: String, expirationTimestamp: Int, nonce: Int, receiverStarkKey: String, receiverVaultId: Int, senderVaultId: Int, starkSignature: String) {
        self.amount = amount
